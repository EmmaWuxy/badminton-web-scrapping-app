...
def create(headings:list, table_array:list, num_display:Optional[int])->None:
    ...
    [sg.Table(values = table_array, headings = headings, key = '-OUTPUT-', auto_size_columns = False, display_row_numbers = True, row_height = 30, col_widths=[40,40,30,10,16,16,16,16,16,16,16])],
